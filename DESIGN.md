...
2. **Author/contact for `metadata.txt`.** ✅ Resolved: **OSMAN IBRAHIM** <osmangeomatics93@gmail.com>. Repository/tracker/homepage URLs use the placeholder slug `github.com/Osman-Geomatics93/CRSmart` (replace with the real one when the repo is created).
